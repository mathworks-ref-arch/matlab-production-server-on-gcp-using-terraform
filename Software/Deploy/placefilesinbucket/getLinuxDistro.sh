...
# This script detects the OS of the VM and then selects appropriate scripts to install the dependencies for MATLAB Production Server on this VM.
...
# This script is accessed from a Google cloud storage bucket by the VM where MATLAB Production Server and MATLAB Runtime is installed.
